...
class Simulator {
  ...
  public:
    Simulator(ElementList *elementList, std::unordered_map<std::string, BattleAction> *actionMap,
              std::array<Unit, 10> *battleUnits) {
    ...
    void SimulateBattle(SimulationTeamSetting *redTeamSetting, SimulationTeamSetting *blueTeamSetting, bool log,
                        std::string batchID);
